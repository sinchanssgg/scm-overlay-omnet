...
4. **Postprocessing (`scripts/analysis`, `scripts/visualization`)**
   ...
   - `metrics_plot.png` shows parent-attack behavior by topology (CBT/ER/Twitch line curves).
   - `parent_attack_beta_summary.csv` records baseline vs parent-attack average beta per topology.
